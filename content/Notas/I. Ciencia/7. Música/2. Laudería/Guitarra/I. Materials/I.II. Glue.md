...
- [^https://youtu.be/19v2oBBEz-4?si=D4DbquOnTpTlL2-l]Time:
...
- **Glue starvation** — over-clamping causing the glue to come out of the joint. It will hold for a while (~25 years) before coming apart.[^https://youtu.be/wHAOe-6vPO4?si=KFG1gLslC0hFiqe8]

<br>

- [^https://youtu.be/Qk11FJMLUUc?si=iWTnCWesuUf60A-4&t=516]Bonding to itself:
  - hot / liquid hide glue — yes;
  - PVA, epoxy — no.

<br>

- Water-based glues (e.g., Titebond Original) are dyeable with water-soluble dye. If it’s powder, mix it with water first.[^https://youtu.be/19v2oBBEz-4?si=D4DbquOnTpTlL2-l]

<br>

- Lubricate the pins / threads with a paste wax to avoid glueing them.[^https://youtu.be/5-ol31YUOD0?si=NxIz2uF_LjF_4HdO]
- Cover a surface with a packing tape to avoid glueing it.[^https://youtu.be/5-ol31YUOD0?si=NxIz2uF_LjF_4HdO]

<br>

- Excess glue (e.g., on braces) can affect tone. → Clean up everything to be neat.[^https://youtu.be/7ClFeZ769BE?si=sB12-Im_ABrwUXmG]
...
- Synthetic glues work mechanically, → leave a skim inside the joint, acting like velcro. Hot hide glue is protein-based, → the proteins absorb into the wood, “stitching” the cellular structure together as the long-chain proteins form.[^https://youtu.be/iYoLUvZ9SH8?si=ezupJB3IHDzvo71_]
...
- The best glue for old instruments.
  - Used for violins since the XVI c.[^https://en.wikipedia.org/wiki/Animal_glue#Hide_glue+https://web.archive.org/web/20120426041320/http://www.karlroyviolinbook.com/pdfs/Glue211-213.pdf]; old Martins, Gibsons.[^https://youtu.be/Raq3pbGmmOg?si=5RVyck1gUGWAdab2]
  - Violin family instruments require periodic disassembly for maintenance. The top is easily removed by prying a palette knife between the top and ribs, and running it all around the joint. To reglue, just apply new hot hide glue to the joint. (If the top were glued on with PVA, removing the top would require heat and steam to disassemble the joint, damaging the varnish; then wood would have to be removed from the joint to ensure no cured PVA glue was remaining before re-gluing the top.)[^https://en.wikipedia.org/wiki/Animal_glue#Hide_glue]
  - Violin makers may glue the center seams of top and back plates together using a rubbed joint rather than using clamps. This technique involves coating half of the joint with hot hide glue, and then rubbing the other half against the joint until the hide glue starts to gel, at which point the glue becomes tacky. At this point the plate is set aside without clamps, and the hide glue pulls the joint together as it hardens.[^https://en.wikipedia.org/wiki/Animal_glue#Hide_glue]
...
4. Leave for 1.5–2 hours — until the granules absorb all the water and the glue looks like tapioca / brown sugar / fish eggs.
5. Heat up the glue in a pot at 145°–165°F (= 62.7°–73.9°C) for 2–4 hours until it becomes honey-like.
6. (Preferably) Leave it in the water of the turned-off pot for 12 hours. <br><br>
...
3. Put the thermometer in the glue.
4. Put the glue jar either in:
   1. baby bottle warmer;
   2. pot;
   3. glue pot.
5. Heat the glue to 145°F = 60°C until it drips off the brush in almost an unbreakable line.
6. To conserve the temperature when removing the jar from the pot: put a few marbles into the glue jar.<br><br>

- Storage: close the jar, store in:
  - fridge — usable for several weeks until molding and smelling bad;
...
2. Heat up the parts to be glued.
   - Glue pot / oil-filled heater / use a heat gun / desk lamp.
3. If the glue began to gel prematurely, add more glue.[^https://youtu.be/g7iK2OI2VE4?si=vFoVXSbZuFIn2pwb]
4. If the glue has hardened prematurely, heat it up and redo.
...
- For:
  - repairability (= when the object will definitely need a repair later);
  - old instruments, when dealing with hide glue joints and hot hide glue’s working time is too short.
...
[^https://www.stewmac.com/luthier-tools-and-supplies/supplies/glue-and-adhesive/glues/wood-glues/titebond-liquid-hide-glue]: [**StewMac**](https://www.stewmac.com/luthier-tools-and-supplies/supplies/glue-and-adhesive/glues/wood-glues/titebond-liquid-hide-glue)

[^https://youtu.be/XSa3WP2khUg?si=ByypWf3BvQF-a6w7]: [**Bruné M. E.**](https://youtu.be/XSa3WP2khUg?si=ByypWf3BvQF-a6w7)

[^https://youtu.be/g7iK2OI2VE4?si=vFoVXSbZuFIn2pwb]: [**Bruné M. E.**](https://youtu.be/g7iK2OI2VE4?si=vFoVXSbZuFIn2pwb)

[^https://youtu.be/stpmQfLrQPo?si=OxXlBS8mJTT1EFqV]: [**O'Brien R.**](https://youtu.be/stpmQfLrQPo?si=OxXlBS8mJTT1EFqV)

[^https://youtube.com/shorts/u_IuTVtYOq8?si=fiGCmcaEkoGdgvNP]: [**Bruné M. E.**](https://youtube.com/shorts/u_IuTVtYOq8?si=fiGCmcaEkoGdgvNP)

[^https://youtu.be/wHAOe-6vPO4?si=uoVaz-t1Sf3QF-Fn]: [**Bruné M. E.**](https://youtu.be/wHAOe-6vPO4?si=uoVaz-t1Sf3QF-Fn)

[^https://youtu.be/iYoLUvZ9SH8?si=RIdeXpLrUxZJAvjv]: [**Bruné M. E.**](https://youtu.be/iYoLUvZ9SH8?si=RIdeXpLrUxZJAvjv)

[^https://www.stewmac.com/video-and-ideas/online-resources/learn-about-repair-tools-and-repair-techniques/using-three-different-glues-where-and-why/]: [**StewMac**](https://www.stewmac.com/video-and-ideas/online-resources/learn-about-repair-tools-and-repair-techniques/using-three-different-glues-where-and-why/)

[^https://youtu.be/wZExe86TxLs?si=x0yJxoPDb8kh_RP4]: [**StewMac**](https://youtu.be/wZExe86TxLs?si=x0yJxoPDb8kh_RP4)

[^https://youtu.be/R8R2DXlqVgU?si=OiApUudeAoMCixtA]: [**Kert M.**](https://youtu.be/R8R2DXlqVgU?si=OiApUudeAoMCixtA)

